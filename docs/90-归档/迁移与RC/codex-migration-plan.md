...
- phase-1 delivery docs: created (`README.md`, `docs/00-当前有效/skill-usage.md`, `docs/90-归档/阶段/phase-1-summary.md`, `docs/90-归档/阶段/phase-2-priorities.md`)
- install script: created and verified (`scripts/install-skills.sh`)
- migration validator: still passing after wrap-up changes
- phase-2 docs: created (`docs/90-归档/阶段/phase-2-smoke-plan.md`, `docs/90-归档/阶段/phase-2-smoke-results.md`, `docs/90-归档/阶段/phase-2-summary.md`)
...
- scope doc: `docs/90-归档/阶段/phase-3-scope.md`
...
- scope doc: `docs/90-归档/阶段/phase-4-scope.md`
...
- scope doc: `docs/90-归档/阶段/phase-5-scope.md`
...
- scope doc: `docs/90-归档/阶段/phase-6-scope.md`
...
- scope doc: `docs/90-归档/阶段/phase-7-scope.md`
...
- `Phase 7A` contract doc: `docs/90-归档/阶段/phase-7a-scan-contract.md`
- `Phase 7B` governance doc: `docs/90-归档/阶段/phase-7b-selective-sync-governance.md`
- `sync-shared-from-genm.sh` now supports `--report`
- `sync-shared-from-genm.sh` now supports `--domain`
- shared dependency map doc: `docs/00-当前有效/shared-asset-dependency-map.md`

## Phase 8 Direction

- eighth-phase scope selected
- scope doc: `docs/90-归档/阶段/phase-8-scope.md`
...
- scope doc: `docs/90-归档/阶段/phase-9-scope.md`
- value-gap analysis: `docs/90-归档/阶段/phase-9-writing-value-gap-analysis.md`
...
- `Phase 9A / P0` smoke status:
  - `novel-package`: pass
- `Phase 9A / P0` smoke results: `docs/90-归档/阶段/phase-9a-p0-package-smoke-results.md`
- `Phase 9B / P0` design status: started
- quality-loop design doc: `docs/90-归档/阶段/phase-9b-quality-loop-design.md`
...
- `Phase 9B / P1` smoke results: `docs/90-归档/阶段/phase-9b-p1-smoke-results.md`
...
- `Phase 9B / P2` smoke results: `docs/90-归档/阶段/phase-9b-p2-smoke-results.md`
...
- scope doc: `docs/90-归档/阶段/phase-10-scope.md`
...
- `Phase 10A / P0` smoke results: `docs/90-归档/阶段/phase-10a-p0-smoke-results.md`
- `Phase 10B / P0` smoke results: `docs/90-归档/阶段/phase-10b-p0-smoke-results.md`
- `Phase 10A / P0` smoke status:
  - `novel-package`: pass
- `Phase 10B / P0` smoke status:
  - `novel-precheck`: pass
- `Phase 10A / P1` smoke results: `docs/90-归档/阶段/phase-10a-p1-smoke-results.md`
- `Phase 10B / P1` smoke results: `docs/90-归档/阶段/phase-10b-p1-smoke-results.md`
...
- scope doc: `docs/90-归档/阶段/phase-11-scope.md`
...
- scope doc: `docs/90-归档/阶段/phase-12-scope.md`
- `Phase 12A`: `v1.0.0` readiness checklist
- `Phase 12B`: readiness assessment
- recommended implementation start:
  - write `docs/90-归档/迁移与RC/v1-readiness-checklist.md`
  - write `docs/90-归档/迁移与RC/v1-readiness-assessment.md`
...
- scope doc: `docs/90-归档/阶段/phase-13-scope.md`
- `Phase 13A`: `v1.0.0-rc1` plan
- `Phase 13B`: RC exit criteria
- recommended implementation start:
  - write `docs/90-归档/迁移与RC/v1-rc-plan.md`
  - write `docs/90-归档/迁移与RC/v1-rc-exit-criteria.md`

## Phase 14 Direction

- fourteenth-phase scope selected
- scope doc: `docs/90-归档/阶段/phase-14-scope.md`
- `Phase 14A`: RC execution log
- `Phase 14B`: writing model and reasoning strategy
- recommended implementation start:
  - write `docs/90-归档/迁移与RC/v1-rc-execution-log.md`
...
- scope doc: `docs/90-归档/阶段/phase-15-scope.md`
...
- scope doc: `docs/90-归档/阶段/phase-16-scope.md`
