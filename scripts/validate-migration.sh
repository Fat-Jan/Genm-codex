...
require_file "${ROOT_DIR}/docs/00-当前有效/host-support-status-v1.6.md"
...
require_file "${ROOT_DIR}/docs/90-归档/阶段/v1.6-host-foundation-implementation-memo.md"
require_file "${ROOT_DIR}/v1.3-roadmap.md"
require_file "${ROOT_DIR}/v1.6-roadmap.md"
...
require_file "${ROOT_DIR}/shared/templates/host-capability-matrix-v1.schema.json"
require_file "${ROOT_DIR}/shared/templates/host-capability-matrix-v1.json"
require_file "${ROOT_DIR}/shared/templates/host-evidence-ledger-v1.schema.json"
require_file "${ROOT_DIR}/shared/templates/host-evidence-ledger-v1.json"
...
require_file "${ROOT_DIR}/scripts/render_memory_context_summary.py"
require_file "${ROOT_DIR}/scripts/render_resume_bundle.py"
...
require_file "${ROOT_DIR}/scripts/render_host_capability_projection.py"
require_file "${ROOT_DIR}/scripts/doctor_host_foundation.py"
...
require_file "${ROOT_DIR}/docs/20-研究实验/trae-capability-review-2026-04-02.md"
